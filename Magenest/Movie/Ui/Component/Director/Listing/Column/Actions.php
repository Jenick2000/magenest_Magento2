...
namespace Magenest\Movie\Ui\Component\Director\Listing\Column;
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $item[$this->getData('name')] = [
                    'edit' => [
                        'href' => $this->urlBuilder->getUrl('magenest/director/edit',['id'=> $item['director_id']]),
                        'label' => __('Edit')
                    ],
                    'delete' => [
                        'href' => $this->urlBuilder->getUrl('magenest/director/remove',['id'=> $item['director_id']]),
                        'label' => __('delete')
                    ]
                ];
            }
